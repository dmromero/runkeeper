...
class WalksControllerTest < ActionController::TestCase
  ...
  test "should create walk" do
    assert_difference('Walk.count') do
      post :create, walk: { calories: @walk.calories, distance: @walk.distance, speed: @walk.speed, stat: @walk.stat, user_id: @walk.user_id }
    end
  ...
  test "should update walk" do
    patch :update, id: @walk, walk: { calories: @walk.calories, distance: @walk.distance, speed: @walk.speed, stat: @walk.stat, user_id: @walk.user_id }
    assert_redirected_to walk_path(assigns(:walk))
  end
